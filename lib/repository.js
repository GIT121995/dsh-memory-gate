        ...
        this.transaction(() => {
            this.db
             ...
             valid_from, valid_until, created_at, updated_at, terms_json, learned_terms_json
                ...
                .run(claim.id, claim.scope, claim.scopeKey, claim.kind, claim.content, JSON.stringify(claim.tags), claim.state, claim.origin, claim.sensitivity, claim.contentHash, claim.sourceSessionId ?? null, claim.sourceEventSeq ?? null, claim.validFrom, claim.validUntil ?? null, claim.createdAt, claim.updatedAt, JSON.stringify(claim.terms), JSON.stringify(claim.learnedTerms));
